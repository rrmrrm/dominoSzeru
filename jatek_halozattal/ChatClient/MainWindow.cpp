#include <QRegExp> // For regular expressions
...
void MainWindow::on_loginButton_clicked()
{
    ...
    // QTcpSocket uses an asynchronous (non-blocking) approach.
    // Operations are scheduled and performed when control returns to Qt's event loop.
    // When the operation is finished, QTcpSocket emits a signal.
    // For example connectToHost() returns immediately, and when it's done, we'll
